...
async def update_order_status(
    ...
    **Related Resources**:
    - ``frontapp://statuses`` — look up status codes

    Args:
        context: FastMCP context for services and elicitation
        order_id: The Frontapp order id
...
class UpdateOrderStatusRequest(BaseModel):
    ...
    order_id: int = Field(..., description="Frontapp order id")
...
```python
from frontapp_mcp.templates import format_template
...
Templates live in `frontapp_mcp_server/src/frontapp_mcp/templates/*.md`
...
- Layer 5 (response templates): not yet required — Frontapp tool responses are small
...
- [scripts/generate_tools_json.py](../../../scripts/generate_tools_json.py) - Metadata
  generator
- [frontapp_mcp/templates/](../../src/frontapp_mcp/templates/) - Response templates
- [frontapp_mcp/logging.py](../../src/frontapp_mcp/logging.py) - Observability
  decorators
- [Google Style Docstrings](https://google.github.io/styleguide/pyguide.html#38-comments-and-docstrings)
- [PR #167](https://github.com/dougborg/frontapp-openapi-client/pull/167) -
  Observability decorators
- [PR #169](https://github.com/dougborg/frontapp-openapi-client/pull/169) - Template
  externalization
- [PR #170](https://github.com/dougborg/frontapp-openapi-client/pull/170) - Tools.json
  generator
