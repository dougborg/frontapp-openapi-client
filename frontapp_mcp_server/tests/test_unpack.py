...
import pytest
from frontapp_mcp.unpack import Unpack, unpack_pydantic_params
...
class TestUnpackWithFastMCPSimulation:
    ...
    async def test_async_tool_simulation(self):
        ...
        result = await update_conversation(name="cnv_abc", limit=50)
        assert result == {"name": "cnv_abc", "limit": 50, "stock": 100}
