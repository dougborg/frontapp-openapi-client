"""Structured logging configuration for Frontapp MCP Server.
...
- FRONTAPP_MCP_LOG_LEVEL: Log level (DEBUG, INFO, WARNING, ERROR) - default INFO
- FRONTAPP_MCP_LOG_FORMAT: Output format (json, text) - default json
...
def setup_logging(log_level: str | None = None, log_format: str | None = None) -> None:
    ...
    Args:
        log_level: Log level (DEBUG, INFO, WARNING, ERROR).
                  If None, reads from FRONTAPP_MCP_LOG_LEVEL env var.
                  Defaults to INFO.
        log_format: Output format (json or text).
                   If None, reads from FRONTAPP_MCP_LOG_FORMAT env var.
                   Defaults to json.
    """
    # Get configuration from environment or parameters
    level = log_level or os.getenv("FRONTAPP_MCP_LOG_LEVEL", "INFO").upper()
    format_type = log_format or os.getenv("FRONTAPP_MCP_LOG_FORMAT", "json").lower()
