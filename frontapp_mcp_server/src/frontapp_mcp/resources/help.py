"""MCP resource: tool reference and workflow guide for Frontapp."""
...
- `frontapp://statuses` — JSON list of all defined statuses (cached read).
- `frontapp://help` — this document.
...
Frontapp documents rate limits per-endpoint in its OpenAPI description (not
