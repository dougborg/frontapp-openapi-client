...
Building an API client for Frontapp Manufacturing ERP requires:
...
The Frontapp API provides an OpenAPI 3.1.0 specification with complete endpoint
coverage.
...
1. Maintain OpenAPI spec in `docs/frontapp-openapi.yaml`
...
- **Custom code** (`frontapp_client.py`, `utils.py`): Hand-written enhancements
...
- `frontapp_client.py`: Enhanced client with resilience
...
- [Frontapp API Documentation](https://help.frontapp.com/api)
- [scripts/regenerate_client.py](../../scripts/regenerate_client.py)
- [docs/frontapp-openapi.yaml](../frontapp-openapi.yaml)
