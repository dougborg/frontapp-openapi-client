...
1. **Domain Grouping**: Split generated models into domain-grouped files using AST
   parsing. Frontapp groups are small (errors, orders, statuses); the machinery is
...
│   ├── _base.py              # FrontappPydanticBase with conversion methods
...
```python
from frontapp_public_api_client.models_pydantic import OrderResponse as PydanticOrder
from frontapp_public_api_client.models import OrderResponse as AttrsOrder
...
base-class = "frontapp_public_api_client.models_pydantic._base.FrontappPydanticBase"
```
