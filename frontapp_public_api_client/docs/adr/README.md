# Architecture Decision Records — Frontapp OpenAPI Client

This directory contains Architecture Decision Records (ADRs) specific to the
`frontapp-openapi-client` package.

> **Inherited from the parent project.** This repository was forked from
> `katana-openapi-client`. The decisions captured here still apply to Frontapp
