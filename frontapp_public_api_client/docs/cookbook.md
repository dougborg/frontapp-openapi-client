...
async with FrontappClient(max_pages=500) as client:
    # per_page defaults to Frontapp's max (100) when omitted.
...
```python
from frontapp_public_api_client import FrontappClient
from frontapp_public_api_client.api.orders import add_order_comment
from frontapp_public_api_client.models.add_order_comment_request import (
    AddOrderCommentRequest,
)
from frontapp_public_api_client.utils import is_success, RateLimitError
