"""Logging setup utilities for the Frontapp API client.

This module provides logging configuration helpers for the enhanced Frontapp client.
...
def setup_logging(
    log_dir: str = "logs",
    log_file_prefix: str = "frontapp_client",
    log_level: int = logging.INFO,
    console_level: int = logging.INFO,
    max_bytes: int = 10 * 1024 * 1024,  # 10MB
    backup_count: int = 5,
) -> logging.Logger:
    """Set up logging configuration for the Frontapp client.
    ...
    # Create logger
    logger = logging.getLogger("frontapp_client")
...
def get_logger(name: str | None = None) -> logging.Logger:
    ...
    Args:
        name: Logger name (defaults to frontapp_client)

    Returns:
        Logger instance

    """
    return logging.getLogger(name or "frontapp_client")
