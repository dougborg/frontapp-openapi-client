...
T = TypeVar("T", bound=FrontappPydanticBase)


@overload
def convert_response[T: FrontappPydanticBase](
...
def convert_response[T: FrontappPydanticBase](
    ...
    Example:
        ...
        from frontapp_public_api_client.models_pydantic import Product
        from frontapp_public_api_client.models_pydantic.converters import (
            convert_response,
        )
...
def batch_convert[T: FrontappPydanticBase](
...
def batch_convert_to_attrs(
    pydantic_objects: Sequence[FrontappPydanticBase],
) -> list[object]:
...
def to_pydantic(attrs_obj: object) -> FrontappPydanticBase | None:
...
def to_attrs(pydantic_obj: FrontappPydanticBase) -> object | None:
