...
if TYPE_CHECKING:
    from ..models.list_teammate_signatures_response_200_links import (
        ListTeammateSignaturesResponse200Links,
    )
    from ..models.list_teammate_signatures_response_200_pagination import (
        ListTeammateSignaturesResponse200Pagination,
    )
    from ..models.signature_response import SignatureResponse


T = TypeVar("T", bound="ListTeammateSignaturesResponse200")


@_attrs_define
class ListTeammateSignaturesResponse200:
    field_pagination: ListTeammateSignaturesResponse200Pagination | Unset = UNSET
    field_links: ListTeammateSignaturesResponse200Links | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_pagination: ListTeammateSignaturesResponse200Pagination | Unset
        if isinstance(_field_pagination, Unset):
            field_pagination = UNSET
        else:
            field_pagination = ListTeammateSignaturesResponse200Pagination.from_dict(
                _field_pagination
            )

        _field_links = d.pop("_links", UNSET)
        field_links: ListTeammateSignaturesResponse200Links | Unset
        if isinstance(_field_links, Unset):
            field_links = UNSET
        else:
            field_links = ListTeammateSignaturesResponse200Links.from_dict(_field_links)
        ...
        list_teammate_signatures_response_200 = cls(
            field_pagination=field_pagination,
            field_links=field_links,
            field_results=field_results,
        )

        list_teammate_signatures_response_200.additional_properties = d
        return list_teammate_signatures_response_200
