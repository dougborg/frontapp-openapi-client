...
if TYPE_CHECKING:
    from ..models.list_teams_response_200_links import ListTeamsResponse200Links
...
class ListTeamsResponse200:
    field_links: ListTeamsResponse200Links | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_links: ListTeamsResponse200Links | Unset
        if isinstance(_field_links, Unset):
            field_links = UNSET
        else:
            field_links = ListTeamsResponse200Links.from_dict(_field_links)
        ...
        list_teams_response_200.additional_properties = d
