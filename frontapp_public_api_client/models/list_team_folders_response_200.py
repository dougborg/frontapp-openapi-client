...
if TYPE_CHECKING:
    from ..models.list_team_folders_response_200_links import (
        ListTeamFoldersResponse200Links,
    )
    from ..models.list_team_folders_response_200_pagination import (
        ListTeamFoldersResponse200Pagination,
    )
    from ..models.message_template_folder_response import MessageTemplateFolderResponse


T = TypeVar("T", bound="ListTeamFoldersResponse200")


@_attrs_define
class ListTeamFoldersResponse200:
    field_pagination: ListTeamFoldersResponse200Pagination | Unset = UNSET
    field_links: ListTeamFoldersResponse200Links | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_pagination: ListTeamFoldersResponse200Pagination | Unset
        if isinstance(_field_pagination, Unset):
            field_pagination = UNSET
        else:
            field_pagination = ListTeamFoldersResponse200Pagination.from_dict(
                _field_pagination
            )

        _field_links = d.pop("_links", UNSET)
        field_links: ListTeamFoldersResponse200Links | Unset
        if isinstance(_field_links, Unset):
            field_links = UNSET
        else:
            field_links = ListTeamFoldersResponse200Links.from_dict(_field_links)
        ...
        list_team_folders_response_200 = cls(
            field_pagination=field_pagination,
            field_links=field_links,
            field_results=field_results,
        )

        list_team_folders_response_200.additional_properties = d
        return list_team_folders_response_200
