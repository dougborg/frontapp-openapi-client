...
if TYPE_CHECKING:
    ...
    from ..models.list_conversation_custom_fields_response_200_links import (
        ListConversationCustomFieldsResponse200Links,
    )


T = TypeVar("T", bound="ListConversationCustomFieldsResponse200")


@_attrs_define
class ListConversationCustomFieldsResponse200:
    field_links: ListConversationCustomFieldsResponse200Links | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_links: ListConversationCustomFieldsResponse200Links | Unset
        if isinstance(_field_links, Unset):
            field_links = UNSET
        else:
            field_links = ListConversationCustomFieldsResponse200Links.from_dict(
                _field_links
            )
        ...
        list_conversation_custom_fields_response_200 = cls(
            field_links=field_links,
            field_results=field_results,
        )

        list_conversation_custom_fields_response_200.additional_properties = d
        return list_conversation_custom_fields_response_200
