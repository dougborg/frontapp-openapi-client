...
if TYPE_CHECKING:
    from ..models.list_team_shifts_response_200_links import (
        ListTeamShiftsResponse200Links,
    )
    from ..models.shift_response import ShiftResponse


T = TypeVar("T", bound="ListTeamShiftsResponse200")


@_attrs_define
class ListTeamShiftsResponse200:
    field_links: ListTeamShiftsResponse200Links | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_links: ListTeamShiftsResponse200Links | Unset
        if isinstance(_field_links, Unset):
            field_links = UNSET
        else:
            field_links = ListTeamShiftsResponse200Links.from_dict(_field_links)
        ...
        list_team_shifts_response_200 = cls(
            field_links=field_links,
            field_results=field_results,
        )

        list_team_shifts_response_200.additional_properties = d
        return list_team_shifts_response_200
