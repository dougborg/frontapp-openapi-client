...
from ..models.create_draft_mode import CreateDraftMode

T = TypeVar("T", bound="CreateDraft")
...
class CreateDraft:
    ...
    mode: CreateDraftMode | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mode: CreateDraftMode | Unset
        if isinstance(_mode, Unset):
            mode = UNSET
        else:
            mode = CreateDraftMode(_mode)
        ...
        create_draft.additional_properties = d
        return create_draft
