...
if TYPE_CHECKING:
    ...
    from ..models.list_events_response_200_links import ListEventsResponse200Links
    from ..models.list_events_response_200_pagination import (
...
class ListEventsResponse200:
    field_pagination: ListEventsResponse200Pagination | Unset = UNSET
    field_links: ListEventsResponse200Links | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_pagination: ListEventsResponse200Pagination | Unset
        if isinstance(_field_pagination, Unset):
            field_pagination = UNSET
        else:
            field_pagination = ListEventsResponse200Pagination.from_dict(
                _field_pagination
            )

        _field_links = d.pop("_links", UNSET)
        field_links: ListEventsResponse200Links | Unset
        if isinstance(_field_links, Unset):
            field_links = UNSET
        else:
            field_links = ListEventsResponse200Links.from_dict(_field_links)
