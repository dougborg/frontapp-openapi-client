...
if TYPE_CHECKING:
    ...
    from ..models.list_accounts_response_200_links import ListAccountsResponse200Links
    from ..models.list_accounts_response_200_pagination import (
...
class ListAccountsResponse200:
    field_pagination: ListAccountsResponse200Pagination | Unset = UNSET
    field_links: ListAccountsResponse200Links | Unset = UNSET
    field_results: list[AccountResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.account_response import AccountResponse
        from ..models.list_accounts_response_200_links import (
        ...
        field_pagination: ListAccountsResponse200Pagination | Unset
        if isinstance(_field_pagination, Unset):
            field_pagination = UNSET
        else:
            field_pagination = ListAccountsResponse200Pagination.from_dict(
                _field_pagination
            )

        _field_links = d.pop("_links", UNSET)
        field_links: ListAccountsResponse200Links | Unset
        if isinstance(_field_links, Unset):
            field_links = UNSET
        else:
            field_links = ListAccountsResponse200Links.from_dict(_field_links)
        ...
        if _field_results is not UNSET:
            ...
            for field_results_item_data in _field_results:
                field_results_item = AccountResponse.from_dict(field_results_item_data)
