...
if TYPE_CHECKING:
    from ..models.list_views_response_200_links import ListViewsResponse200Links
    from ..models.list_views_response_200_pagination import (
        ListViewsResponse200Pagination,
    )
    from ..models.shared_view_response import SharedViewResponse


T = TypeVar("T", bound="ListViewsResponse200")


@_attrs_define
class ListViewsResponse200:
    field_pagination: ListViewsResponse200Pagination | Unset = UNSET
    field_links: ListViewsResponse200Links | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_pagination: ListViewsResponse200Pagination | Unset
        if isinstance(_field_pagination, Unset):
            field_pagination = UNSET
        else:
            field_pagination = ListViewsResponse200Pagination.from_dict(
                _field_pagination
            )

        _field_links = d.pop("_links", UNSET)
        field_links: ListViewsResponse200Links | Unset
        if isinstance(_field_links, Unset):
            field_links = UNSET
        else:
            field_links = ListViewsResponse200Links.from_dict(_field_links)
        ...
        list_views_response_200 = cls(
            field_pagination=field_pagination,
            field_links=field_links,
            field_results=field_results,
        )

        list_views_response_200.additional_properties = d
        return list_views_response_200
