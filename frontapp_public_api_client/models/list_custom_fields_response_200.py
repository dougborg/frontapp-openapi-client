...
if TYPE_CHECKING:
    ...
    from ..models.list_custom_fields_response_200_links import (
        ListCustomFieldsResponse200Links,
    )


T = TypeVar("T", bound="ListCustomFieldsResponse200")


@_attrs_define
class ListCustomFieldsResponse200:
    field_links: ListCustomFieldsResponse200Links | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_links: ListCustomFieldsResponse200Links | Unset
        if isinstance(_field_links, Unset):
            field_links = UNSET
        else:
            field_links = ListCustomFieldsResponse200Links.from_dict(_field_links)
        ...
        list_custom_fields_response_200 = cls(
            field_links=field_links,
            field_results=field_results,
        )

        list_custom_fields_response_200.additional_properties = d
        return list_custom_fields_response_200
