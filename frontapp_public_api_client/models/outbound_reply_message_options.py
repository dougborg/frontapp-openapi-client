...
T = TypeVar("T", bound="OutboundReplyMessageOptions")


@_attrs_define
class OutboundReplyMessageOptions:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        outbound_reply_message_options = cls(
            tag_ids=tag_ids,
            archive=archive,
        )

        outbound_reply_message_options.additional_properties = d
        return outbound_reply_message_options
