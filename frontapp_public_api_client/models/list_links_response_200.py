...
if TYPE_CHECKING:
    ...
    from ..models.list_links_response_200_links import ListLinksResponse200Links
    from ..models.list_links_response_200_pagination import (
        ListLinksResponse200Pagination,
    )


T = TypeVar("T", bound="ListLinksResponse200")


@_attrs_define
class ListLinksResponse200:
    field_pagination: ListLinksResponse200Pagination | Unset = UNSET
    field_links: ListLinksResponse200Links | Unset = UNSET
    field_results: list[LinkResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_pagination: ListLinksResponse200Pagination | Unset
        if isinstance(_field_pagination, Unset):
            field_pagination = UNSET
        else:
            field_pagination = ListLinksResponse200Pagination.from_dict(
                _field_pagination
            )

        _field_links = d.pop("_links", UNSET)
        field_links: ListLinksResponse200Links | Unset
        if isinstance(_field_links, Unset):
            field_links = UNSET
        else:
            field_links = ListLinksResponse200Links.from_dict(_field_links)
        ...
        if _field_results is not UNSET:
            ...
            for field_results_item_data in _field_results:
                field_results_item = LinkResponse.from_dict(field_results_item_data)

                field_results.append(field_results_item)

        list_links_response_200 = cls(
            field_pagination=field_pagination,
            field_links=field_links,
            field_results=field_results,
        )

        list_links_response_200.additional_properties = d
        return list_links_response_200
