...
if TYPE_CHECKING:
    from ..models.list_message_templates_response_200_links import (
        ListMessageTemplatesResponse200Links,
    )
    from ..models.list_message_templates_response_200_pagination import (
        ListMessageTemplatesResponse200Pagination,
    )
    from ..models.message_template_response import MessageTemplateResponse


T = TypeVar("T", bound="ListMessageTemplatesResponse200")


@_attrs_define
class ListMessageTemplatesResponse200:
    field_pagination: ListMessageTemplatesResponse200Pagination | Unset = UNSET
    field_links: ListMessageTemplatesResponse200Links | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_pagination: ListMessageTemplatesResponse200Pagination | Unset
        if isinstance(_field_pagination, Unset):
            field_pagination = UNSET
        else:
            field_pagination = ListMessageTemplatesResponse200Pagination.from_dict(
                _field_pagination
            )

        _field_links = d.pop("_links", UNSET)
        field_links: ListMessageTemplatesResponse200Links | Unset
        if isinstance(_field_links, Unset):
            field_links = UNSET
        else:
            field_links = ListMessageTemplatesResponse200Links.from_dict(_field_links)
        ...
        list_message_templates_response_200 = cls(
            field_pagination=field_pagination,
            field_links=field_links,
            field_results=field_results,
        )

        list_message_templates_response_200.additional_properties = d
        return list_message_templates_response_200
