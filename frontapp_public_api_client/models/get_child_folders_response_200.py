...
if TYPE_CHECKING:
    from ..models.get_child_folders_response_200_links import (
        GetChildFoldersResponse200Links,
    )
    from ..models.get_child_folders_response_200_pagination import (
        GetChildFoldersResponse200Pagination,
    )
    from ..models.message_template_folder_response import MessageTemplateFolderResponse


T = TypeVar("T", bound="GetChildFoldersResponse200")


@_attrs_define
class GetChildFoldersResponse200:
    field_pagination: GetChildFoldersResponse200Pagination | Unset = UNSET
    field_links: GetChildFoldersResponse200Links | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_pagination: GetChildFoldersResponse200Pagination | Unset
        if isinstance(_field_pagination, Unset):
            field_pagination = UNSET
        else:
            field_pagination = GetChildFoldersResponse200Pagination.from_dict(
                _field_pagination
            )

        _field_links = d.pop("_links", UNSET)
        field_links: GetChildFoldersResponse200Links | Unset
        if isinstance(_field_links, Unset):
            field_links = UNSET
        else:
            field_links = GetChildFoldersResponse200Links.from_dict(_field_links)
        ...
        get_child_folders_response_200 = cls(
            field_pagination=field_pagination,
            field_links=field_links,
            field_results=field_results,
        )

        get_child_folders_response_200.additional_properties = d
        return get_child_folders_response_200
