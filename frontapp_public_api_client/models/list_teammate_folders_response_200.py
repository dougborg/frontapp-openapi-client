...
if TYPE_CHECKING:
    from ..models.list_teammate_folders_response_200_links import (
        ListTeammateFoldersResponse200Links,
    )
    from ..models.list_teammate_folders_response_200_pagination import (
...
T = TypeVar("T", bound="ListTeammateFoldersResponse200")


@_attrs_define
class ListTeammateFoldersResponse200:
    field_pagination: ListTeammateFoldersResponse200Pagination | Unset = UNSET
    field_links: ListTeammateFoldersResponse200Links | Unset = UNSET
    field_results: list[MessageTemplateFolderResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.message_template_folder_response import (
            MessageTemplateFolderResponse,
        )

        d = dict(src_dict)
        _field_pagination = d.pop("_pagination", UNSET)
        field_pagination: ListTeammateFoldersResponse200Pagination | Unset
        if isinstance(_field_pagination, Unset):
            field_pagination = UNSET
        else:
            field_pagination = ListTeammateFoldersResponse200Pagination.from_dict(
                _field_pagination
            )

        _field_links = d.pop("_links", UNSET)
        field_links: ListTeammateFoldersResponse200Links | Unset
        if isinstance(_field_links, Unset):
            field_links = UNSET
        else:
            field_links = ListTeammateFoldersResponse200Links.from_dict(_field_links)
        ...
        if _field_results is not UNSET:
            ...
            for field_results_item_data in _field_results:
                field_results_item = MessageTemplateFolderResponse.from_dict(
                    field_results_item_data
                )

                field_results.append(field_results_item)

        list_teammate_folders_response_200 = cls(
            field_pagination=field_pagination,
            field_links=field_links,
            field_results=field_results,
        )

        list_teammate_folders_response_200.additional_properties = d
        return list_teammate_folders_response_200
