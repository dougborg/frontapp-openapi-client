...
T = TypeVar("T", bound="KnowledgeBaseCategorySlimResponseLinksRelated")


@_attrs_define
class KnowledgeBaseCategorySlimResponseLinksRelated:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        knowledge_base_category_slim_response_links_related = cls(
            knowledge_base=knowledge_base,
            parent_category=parent_category,
            articles=articles,
        )

        knowledge_base_category_slim_response_links_related.additional_properties = d
        return knowledge_base_category_slim_response_links_related
