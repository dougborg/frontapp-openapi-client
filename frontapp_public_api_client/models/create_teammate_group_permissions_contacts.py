...
T = TypeVar("T", bound="CreateTeammateGroupPermissionsContacts")


@_attrs_define
class CreateTeammateGroupPermissionsContacts:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_teammate_group_permissions_contacts = cls(
            access=access,
            contact_group_ids=contact_group_ids,
            contact_list_ids=contact_list_ids,
        )

        create_teammate_group_permissions_contacts.additional_properties = d
        return create_teammate_group_permissions_contacts
