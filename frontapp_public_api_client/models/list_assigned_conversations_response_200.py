...
if TYPE_CHECKING:
    ...
    from ..models.list_assigned_conversations_response_200_links import (
        ListAssignedConversationsResponse200Links,
    )
    from ..models.list_assigned_conversations_response_200_pagination import (
        ListAssignedConversationsResponse200Pagination,
    )


T = TypeVar("T", bound="ListAssignedConversationsResponse200")


@_attrs_define
class ListAssignedConversationsResponse200:
    field_pagination: ListAssignedConversationsResponse200Pagination | Unset = UNSET
    field_links: ListAssignedConversationsResponse200Links | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_pagination: ListAssignedConversationsResponse200Pagination | Unset
        if isinstance(_field_pagination, Unset):
            field_pagination = UNSET
        else:
            field_pagination = ListAssignedConversationsResponse200Pagination.from_dict(
                _field_pagination
            )

        _field_links = d.pop("_links", UNSET)
        field_links: ListAssignedConversationsResponse200Links | Unset
        if isinstance(_field_links, Unset):
            field_links = UNSET
        else:
            field_links = ListAssignedConversationsResponse200Links.from_dict(
                _field_links
            )
        ...
        list_assigned_conversations_response_200 = cls(
            field_pagination=field_pagination,
            field_links=field_links,
            field_results=field_results,
        )

        list_assigned_conversations_response_200.additional_properties = d
        return list_assigned_conversations_response_200
