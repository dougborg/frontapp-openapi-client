...
T = TypeVar("T", bound="CreateMessageTemplateFolder")


@_attrs_define
class CreateMessageTemplateFolder:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_message_template_folder = cls(
            name=name,
            parent_folder_id=parent_folder_id,
        )

        create_message_template_folder.additional_properties = d
        return create_message_template_folder
