...
T = TypeVar("T", bound="CreateConversationComment")


@_attrs_define
class CreateConversationComment:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_conversation_comment = cls(
            body=body,
            author_id=author_id,
            attachments=attachments,
        )

        create_conversation_comment.additional_properties = d
        return create_conversation_comment
