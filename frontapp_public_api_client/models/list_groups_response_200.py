...
if TYPE_CHECKING:
    ...
    from ..models.list_groups_response_200_links import ListGroupsResponse200Links
...
class ListGroupsResponse200:
    field_links: ListGroupsResponse200Links | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_links: ListGroupsResponse200Links | Unset
        if isinstance(_field_links, Unset):
            field_links = UNSET
        else:
            field_links = ListGroupsResponse200Links.from_dict(_field_links)
