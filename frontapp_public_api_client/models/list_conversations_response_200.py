...
if TYPE_CHECKING:
    ...
    from ..models.list_conversations_response_200_links import (
        ListConversationsResponse200Links,
    )
    from ..models.list_conversations_response_200_pagination import (
        ListConversationsResponse200Pagination,
    )


T = TypeVar("T", bound="ListConversationsResponse200")


@_attrs_define
class ListConversationsResponse200:
    field_pagination: ListConversationsResponse200Pagination | Unset = UNSET
    field_links: ListConversationsResponse200Links | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_pagination: ListConversationsResponse200Pagination | Unset
        if isinstance(_field_pagination, Unset):
            field_pagination = UNSET
        else:
            field_pagination = ListConversationsResponse200Pagination.from_dict(
                _field_pagination
            )

        _field_links = d.pop("_links", UNSET)
        field_links: ListConversationsResponse200Links | Unset
        if isinstance(_field_links, Unset):
            field_links = UNSET
        else:
            field_links = ListConversationsResponse200Links.from_dict(_field_links)
        ...
        list_conversations_response_200 = cls(
            field_pagination=field_pagination,
            field_links=field_links,
            field_results=field_results,
        )

        list_conversations_response_200.additional_properties = d
        return list_conversations_response_200
