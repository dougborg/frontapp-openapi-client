...
if TYPE_CHECKING:
    from ..models.list_team_views_response_200_links import (
        ListTeamViewsResponse200Links,
    )
    from ..models.list_team_views_response_200_pagination import (
        ListTeamViewsResponse200Pagination,
    )
    from ..models.shared_view_response import SharedViewResponse


T = TypeVar("T", bound="ListTeamViewsResponse200")


@_attrs_define
class ListTeamViewsResponse200:
    field_pagination: ListTeamViewsResponse200Pagination | Unset = UNSET
    field_links: ListTeamViewsResponse200Links | Unset = UNSET
    field_results: list[SharedViewResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_pagination: ListTeamViewsResponse200Pagination | Unset
        if isinstance(_field_pagination, Unset):
            field_pagination = UNSET
        else:
            field_pagination = ListTeamViewsResponse200Pagination.from_dict(
                _field_pagination
            )

        _field_links = d.pop("_links", UNSET)
        field_links: ListTeamViewsResponse200Links | Unset
        if isinstance(_field_links, Unset):
            field_links = UNSET
        else:
            field_links = ListTeamViewsResponse200Links.from_dict(_field_links)
        ...
        if _field_results is not UNSET:
            ...
            for field_results_item_data in _field_results:
                field_results_item = SharedViewResponse.from_dict(
                    field_results_item_data
                )

                field_results.append(field_results_item)

        list_team_views_response_200 = cls(
            field_pagination=field_pagination,
            field_links=field_links,
            field_results=field_results,
        )

        list_team_views_response_200.additional_properties = d
        return list_team_views_response_200
