...
if TYPE_CHECKING:
    ...
    from ..models.list_contacts_response_200_links import ListContactsResponse200Links
    from ..models.list_contacts_response_200_pagination import (
...
class ListContactsResponse200:
    field_pagination: ListContactsResponse200Pagination | Unset = UNSET
    field_links: ListContactsResponse200Links | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.contact_response import ContactResponse
        from ..models.list_contacts_response_200_links import (
        ...
        field_pagination: ListContactsResponse200Pagination | Unset
        if isinstance(_field_pagination, Unset):
            field_pagination = UNSET
        else:
            field_pagination = ListContactsResponse200Pagination.from_dict(
                _field_pagination
            )

        _field_links = d.pop("_links", UNSET)
        field_links: ListContactsResponse200Links | Unset
        if isinstance(_field_links, Unset):
            field_links = UNSET
        else:
            field_links = ListContactsResponse200Links.from_dict(_field_links)
