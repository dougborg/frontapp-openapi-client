...
if TYPE_CHECKING:
    ...
    from ..models.list_categories_in_a_knowledge_base_response_200_links import (
        ListCategoriesInAKnowledgeBaseResponse200Links,
    )
    from ..models.list_categories_in_a_knowledge_base_response_200_pagination import (
        ListCategoriesInAKnowledgeBaseResponse200Pagination,
    )


T = TypeVar("T", bound="ListCategoriesInAKnowledgeBaseResponse200")


@_attrs_define
class ListCategoriesInAKnowledgeBaseResponse200:
    field_pagination: ListCategoriesInAKnowledgeBaseResponse200Pagination | Unset = (
        UNSET
    )
    field_links: ListCategoriesInAKnowledgeBaseResponse200Links | Unset = UNSET
    field_results: list[KnowledgeBaseCategorySlimResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_pagination, Unset):
            ...
            field_pagination = (
                ListCategoriesInAKnowledgeBaseResponse200Pagination.from_dict(
                    _field_pagination
                )
            )

        _field_links = d.pop("_links", UNSET)
        field_links: ListCategoriesInAKnowledgeBaseResponse200Links | Unset
        if isinstance(_field_links, Unset):
            field_links = UNSET
        else:
            field_links = ListCategoriesInAKnowledgeBaseResponse200Links.from_dict(
                _field_links
            )
        ...
        if _field_results is not UNSET:
            ...
            for field_results_item_data in _field_results:
                field_results_item = KnowledgeBaseCategorySlimResponse.from_dict(
                    field_results_item_data
                )

                field_results.append(field_results_item)

        list_categories_in_a_knowledge_base_response_200 = cls(
            field_pagination=field_pagination,
            field_links=field_links,
            field_results=field_results,
        )

        list_categories_in_a_knowledge_base_response_200.additional_properties = d
        return list_categories_in_a_knowledge_base_response_200
