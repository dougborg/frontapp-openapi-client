...
T = TypeVar("T", bound="UpdateMessageTemplateFolder")
...
class UpdateMessageTemplateFolder:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_message_template_folder = cls(
            name=name,
            parent_folder_id=parent_folder_id,
        )

        update_message_template_folder.additional_properties = d
        return update_message_template_folder
