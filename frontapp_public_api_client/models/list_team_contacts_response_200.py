...
if TYPE_CHECKING:
    ...
    from ..models.list_team_contacts_response_200_links import (
        ListTeamContactsResponse200Links,
    )
    from ..models.list_team_contacts_response_200_pagination import (
        ListTeamContactsResponse200Pagination,
    )


T = TypeVar("T", bound="ListTeamContactsResponse200")


@_attrs_define
class ListTeamContactsResponse200:
    field_pagination: ListTeamContactsResponse200Pagination | Unset = UNSET
    field_links: ListTeamContactsResponse200Links | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_pagination: ListTeamContactsResponse200Pagination | Unset
        if isinstance(_field_pagination, Unset):
            field_pagination = UNSET
        else:
            field_pagination = ListTeamContactsResponse200Pagination.from_dict(
                _field_pagination
            )

        _field_links = d.pop("_links", UNSET)
        field_links: ListTeamContactsResponse200Links | Unset
        if isinstance(_field_links, Unset):
            field_links = UNSET
        else:
            field_links = ListTeamContactsResponse200Links.from_dict(_field_links)
        ...
        list_team_contacts_response_200 = cls(
            field_pagination=field_pagination,
            field_links=field_links,
            field_results=field_results,
        )

        list_team_contacts_response_200.additional_properties = d
        return list_team_contacts_response_200
