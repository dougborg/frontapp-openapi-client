"""Base domain model for Frontapp entities.

This module provides the foundation for Pydantic domain models that represent
business entities from the Frontapp Manufacturing ERP system.
...
class FrontappBaseModel(BaseModel):
    ...
    Example:
        ```python
        class OrderDomain(FrontappBaseModel):
            id: int
            name: str
    ...
    model_config = ConfigDict(
        ...
        json_schema_extra={
            "source": "Frontapp Manufacturing ERP",
            "version": "v1",
        },
    )
    ...
    # Common timestamp fields (most Frontapp entities have these)
