...
from ...models.list_teammate_groups_response_200 import ListTeammateGroupsResponse200
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/teammates/{teammate_id}/contact_groups".format(
...
) -> ListTeammateGroupsResponse200 | None:
    if response.status_code == 200:
        response_200 = ListTeammateGroupsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ListTeammateGroupsResponse200]:
    return Response(
