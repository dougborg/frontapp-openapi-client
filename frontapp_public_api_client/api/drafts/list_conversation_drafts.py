...
from ...models.list_conversation_drafts_response_200 import (
...
) -> Any | ListConversationDraftsResponse200 | None:
    if response.status_code == 200:
        response_200 = ListConversationDraftsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ListConversationDraftsResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | ListConversationDraftsResponse200
    """
