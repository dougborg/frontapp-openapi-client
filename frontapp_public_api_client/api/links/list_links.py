...
from ...models.list_links_response_200 import ListLinksResponse200
from ...models.list_links_sort_order import ListLinksSortOrder
...
def _get_kwargs(
    *,
    ...
    sort_order: ListLinksSortOrder | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ListLinksResponse200 | None:
    if response.status_code == 200:
        response_200 = ListLinksResponse200.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sort_by (str | Unset):
        sort_order (ListLinksSortOrder | Unset):  Example: asc.
