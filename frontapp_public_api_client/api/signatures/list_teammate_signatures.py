...
from ...models.list_teammate_signatures_response_200 import (
...
) -> ListTeammateSignaturesResponse200 | None:
    if response.status_code == 200:
        response_200 = ListTeammateSignaturesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ListTeammateSignaturesResponse200]:
    return Response(
