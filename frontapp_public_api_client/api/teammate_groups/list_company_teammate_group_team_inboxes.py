...
from ...models.list_company_teammate_group_team_inboxes_response_200 import (
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/teammate_groups/{teammate_group_id}/inboxes".format(
...
) -> ListCompanyTeammateGroupTeamInboxesResponse200 | None:
    if response.status_code == 200:
        response_200 = ListCompanyTeammateGroupTeamInboxesResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ListCompanyTeammateGroupTeamInboxesResponse200]:
    return Response(
