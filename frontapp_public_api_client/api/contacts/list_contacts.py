...
from ...models.list_contacts_sort_order import ListContactsSortOrder
...
def _get_kwargs(
    *,
    ...
    sort_order: ListContactsSortOrder | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sort_by (str | Unset):
        sort_order (ListContactsSortOrder | Unset):  Example: asc.
