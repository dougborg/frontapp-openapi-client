...
from ...models.list_link_custom_fields_response_200 import (
...
) -> ListLinkCustomFieldsResponse200 | None:
    if response.status_code == 200:
        response_200 = ListLinkCustomFieldsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ListLinkCustomFieldsResponse200]:
    return Response(
