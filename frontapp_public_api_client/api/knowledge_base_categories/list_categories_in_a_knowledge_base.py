...
from ...models.list_categories_in_a_knowledge_base_response_200 import (
...
) -> ListCategoriesInAKnowledgeBaseResponse200 | None:
    if response.status_code == 200:
        response_200 = ListCategoriesInAKnowledgeBaseResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ListCategoriesInAKnowledgeBaseResponse200]:
    return Response(
