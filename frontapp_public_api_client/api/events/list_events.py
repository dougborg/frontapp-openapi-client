...
from ...models.list_events_sort_order import ListEventsSortOrder
...
def _get_kwargs(
    *,
    ...
    sort_order: ListEventsSortOrder | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """List events
     ...
     Lists all the detailed events which occurred in the inboxes of the company ordered in reverse
    ...
    Args:
        ...
        sort_by (str | Unset):
        sort_order (ListEventsSortOrder | Unset):  Example: asc.
