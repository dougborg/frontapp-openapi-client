...
from ...models.delete_folder_response_202 import DeleteFolderResponse202
...
) -> DeleteFolderResponse202 | None:
    if response.status_code == 202:
        response_202 = DeleteFolderResponse202.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[DeleteFolderResponse202]:
    return Response(
