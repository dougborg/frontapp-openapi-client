...
from ...models.remove_conversation_links_body import RemoveConversationLinksBody


def _get_kwargs(
    conversation_id: str = "cnv_123",
    *,
    body: RemoveConversationLinksBody | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/conversations/{conversation_id}/links".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (RemoveConversationLinksBody | Unset):
