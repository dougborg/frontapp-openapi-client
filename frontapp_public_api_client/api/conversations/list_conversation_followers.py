...
from ...models.list_conversation_followers_response_200 import (
...
) -> Any | ListConversationFollowersResponse200 | None:
    if response.status_code == 200:
        response_200 = ListConversationFollowersResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ListConversationFollowersResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | ListConversationFollowersResponse200
    """
