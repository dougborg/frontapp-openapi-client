...
from ...models.delete_conversation_followers_body import DeleteConversationFollowersBody


def _get_kwargs(
    conversation_id: str = "cnv_123",
    *,
    body: DeleteConversationFollowersBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (DeleteConversationFollowersBody | Unset):
