...
from ...models.update_conversation_assignee import UpdateConversationAssignee


def _get_kwargs(
    conversation_id: str = "cnv_123",
    *,
    body: UpdateConversationAssignee | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/conversations/{conversation_id}/assignee".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (UpdateConversationAssignee | Unset):
