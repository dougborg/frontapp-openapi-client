...
Frontapp OpenAPI Client and MCP Server project.
...
1. **Configure Environment**:
   ...
   # Add your Frontapp API key
   FRONTAPP_API_KEY=your-actual-key-here
   ```
...
- `FRONTAPP_API_KEY` - Your Frontapp API key (required for integration tests)
- `FRONTAPP_BASE_URL` - API base URL (defaults to production)
...
- Make sure `FRONTAPP_API_KEY` is set in `.env`
