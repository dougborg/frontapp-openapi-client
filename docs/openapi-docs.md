...
This page contains the complete OpenAPI specification for the Frontapp Manufacturing
ERP API, rendered with Swagger UI for interactive exploration.

## About the Frontapp API

The Frontapp API provides programmatic access to your Frontapp Manufacturing ERP
...
- **And Much More**: Complete access to all Frontapp functionality
...
3. Your API key can be found in your Frontapp account settings
```

!!! info "Base URLs" - **Production**: `https://api2.frontapp.com` -
**Demo/Testing**: Use your specific Frontapp instance URL
...
- **Client Documentation**: See our [FrontappClient Guide](client/guide.md) for
...
[`frontapp-openapi.yaml`](frontapp-openapi.yaml)

This specification includes:

- **100+ API endpoints** across all Frontapp modules
