...
Welcome to the **Frontapp OpenAPI Client** documentation. This is a modern, pythonic
client for the Frontapp Manufacturing ERP API with automatic resilience features.
...
- **Main Client Classes**: `FrontappClient`, `ResilientAsyncTransport`
...
FRONTAPP_BASE_URL=https://api2.frontapp.com  # Optional, defaults to production
...
- **Documentation**:
  [GitHub Pages](https://dougborg.github.io/frontapp-openapi-client/)
- **Issues**:
...
MIT License - see
[LICENSE](https://github.com/dougborg/frontapp-openapi-client/blob/main/LICENSE) for
details.
