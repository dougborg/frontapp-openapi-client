...
**Live Site**: https://dougborg.github.io/frontapp-openapi-client/
...
frontapp_public_api_client/docs/       # Python client documentation
...
frontapp_mcp_server/docs/              # MCP server documentation
...
packages/frontapp-client/docs/         # TypeScript client documentation
...
- [ ] Configure custom domain DNS (frontapp-openapi-client.dougborg.org)
- [ ] Add version information to docs (currently using mike but not configured)
- [ ] Consider removing or consolidating 248 frontapp-api-comprehensive files
