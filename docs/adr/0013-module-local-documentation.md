...
1. **Documentation scattered across multiple locations**:
   ...
   - MCP docs split between `docs/mcp-server/` (5 files) and `frontapp_mcp_server/` (2
     files)
...
│
├── frontapp_public_api_client/          # CLIENT PACKAGE
│   ├── [source code...]
...
│
├── frontapp_mcp_server/                 # MCP PACKAGE
│   ├── [source code...]
...
│   ├── client/                        # Symlink → ../frontapp_public_api_client/docs
│   ├── mcp-server/                    # Symlink → ../frontapp_mcp_server/docs
...
1. Created `frontapp_public_api_client/docs/` and `frontapp_mcp_server/docs/`
   directories
...
- Issue: dougborg/frontapp-openapi-client#118 - Documentation reorganization
