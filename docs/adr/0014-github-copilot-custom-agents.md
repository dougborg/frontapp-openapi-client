...
As the frontapp-openapi-client project grew to include both a Python client library and
...
- `python-mcp-server.instructions.md` → applies to `**/frontapp_mcp_server/**/*.py`
