...
You are a specialized documentation agent for the frontapp-openapi-client project. Create
...
- `docs/FRONTAPP_CLIENT_GUIDE.md` - Client library guide
...
- `frontapp_mcp_server/README.md` - MCP server overview
- `frontapp_mcp_server/src/frontapp_mcp/README.md` - Package docs
...
- Use project terminology (FrontappClient, not "client class")
...
```bash
# Edit guide
vim docs/FRONTAPP_CLIENT_GUIDE.md
