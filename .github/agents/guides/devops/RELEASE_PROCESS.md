...
- `feat(client):` → Releases frontapp-openapi-client (MINOR)
- `fix(client):` → Releases frontapp-openapi-client (PATCH)
- `feat(mcp):` → Releases frontapp-mcp-server (MINOR)
- `fix(mcp):` → Releases frontapp-mcp-server (PATCH)
- `feat(client)!:` → Releases frontapp-openapi-client (MAJOR)
...
### Client Package (`frontapp-openapi-client`)
...
### MCP Server Package (`frontapp-mcp-server`)
