...
- Users must use Frontapp web UI manually
...
```python
# frontapp_mcp_server/src/frontapp_mcp/tools/manufacturing_orders.py
...
async def create_manufacturing_order(
    ...
    # Actual creation
    async with ctx.frontapp_client as client:
...
1. Verify MO appears in Frontapp UI
...
- File: `frontapp_public_api_client/frontapp_client.py:142`
...
```python
# frontapp_mcp_server/src/frontapp_mcp/validation.py
...
def validate_product_exists(
    ...
    """Validate product exists in Frontapp."""
    # Check product exists
    ...

# Usage in tools
from frontapp_mcp.validation import validate_positive_quantity
...
- **Module location**: `src/frontapp_mcp/validation.py`
...
### Scope Labels
- `scope:client` - frontapp-openapi-client package
- `scope:mcp` - frontapp-mcp-server package
