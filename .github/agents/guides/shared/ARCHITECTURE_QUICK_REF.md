...
```python
from frontapp_public_api_client import FrontappClient
from frontapp_public_api_client.api.product import get_all_products
...
```python
from frontapp_public_api_client.domains import Products
...
- **[MCP Architecture](../../../frontapp_mcp_server/docs/architecture.md)** - MCP
  design
