...
1. **frontapp-openapi-client** - Python client library
1. **frontapp-mcp-server** - Model Context Protocol server
...
Triggers release of `frontapp-openapi-client`:
...
Triggers release of `frontapp-mcp-server`:
