...
# frontapp_public_api_client/api/product/get_all_products.py
...
from frontapp_public_api_client.generated.api.product import get_all_products
...
```python
# Editing frontapp_public_api_client/api/product/get_all_products.py
