...
1. **Identify the component** to test:
   - Module path (e.g., `frontapp_public_api_client/helpers/inventory.py`)
...
1. **Setup fixtures** in `conftest.py` if reusable:
   ...
   def mock_api_client():
       ...
       return Mock(spec=FrontappClient)
   ```
...
1. **Mock external dependencies**:
   ...
   def test_api_call():
       responses.add(
           responses.GET,
           "https://api2.frontapp.com/endpoint",
           json={"data": []},
           status=200
       )
       # Test code...
...
from frontapp_public_api_client.helpers.inventory import check_inventory
