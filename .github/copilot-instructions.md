# AI Agent Instructions for Frontapp OpenAPI Client
...
cp .env.example .env
# Edit .env and add your FRONTAPP_API_KEY
...
uv run poe test-integration    # Integration tests (needs FRONTAPP_API_KEY)
...
- **`frontapp_public_api_client/frontapp_client.py`** - Main client with
  `ResilientAsyncTransport`
- **`frontapp_public_api_client/api/`** - 100+ generated API endpoint modules (DO NOT
  EDIT)
- **`frontapp_public_api_client/models/`** - 370+ generated data models (DO NOT EDIT)
- **`frontapp_public_api_client/domain/`** - Pydantic domain models (EDIT THESE)
- **`frontapp_public_api_client/helpers/`** - Helper classes for common operations
- **`frontapp_mcp_server/`** - MCP server implementation (separate package)
...
This means ALL API calls through `FrontappClient` automatically get retries, rate
...
- `frontapp_public_api_client/frontapp_client.py`
- `frontapp_public_api_client/domain/**/*.py`
- `frontapp_public_api_client/helpers/**/*.py`
- `tests/`
- `scripts/`
- `docs/`
...
- **`feat(client):`** / **`fix(client):`** - Releases **frontapp-openapi-client**
  (MINOR/PATCH)
- **`feat(mcp):`** / **`fix(mcp):`** - Releases **frontapp-mcp-server** (MINOR/PATCH)
- **`feat:`** / **`fix:`** (no scope) - Releases **frontapp-openapi-client** (default)
...
1. **Use correct import paths** - Direct imports from `frontapp_public_api_client.api`
   (no `.generated`)
