...
## description: 'Testing standards using pytest for frontapp-openapi-client project' applyTo: \['**/test\_\*.py', '**/\*\_test.py', '\*\*/conftest.py'\]
...
def test_example():
    ...
    client = FrontappClient(api_key="test")
    expected = "result"
...
@pytest.fixture
def frontapp_client():
    """Provide test FrontappClient."""
    return FrontappClient(api_key="test-key")

@pytest.fixture
async def async_client():
    """Provide async FrontappClient."""
...
def test_api_call():
    ...
    responses.add(
        responses.GET,
        "https://api2.frontapp.com/products",
...
# Integration tests (require FRONTAPP_API_KEY)
@pytest.mark.integration
@pytest.mark.skipif(not os.getenv("FRONTAPP_API_KEY"), reason="No API key")
