...
## description: 'Python development standards for frontapp-openapi-client project' applyTo: '\*\*/\*.py'
...
- **Import types correctly**: `from frontapp_public_api_client.client_types import ...`
...
1. **Never edit generated files** - They're in `frontapp_public_api_client/api/` and
