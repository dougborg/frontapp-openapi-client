...
Compare `docs/frontapp-openapi.yaml` (our local spec) against the upstream Frontapp
spec and identify any differences that need resolution.

**Note on upstream source**: Frontapp does not appear to publish their OpenAPI spec at
