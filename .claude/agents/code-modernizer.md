...
- SKIP: `frontapp_public_api_client/api/**/*.py`
- SKIP: `frontapp_public_api_client/models/**/*.py`
- SKIP: `frontapp_public_api_client/client.py`
- SCAN: `frontapp_public_api_client/` (excluding above), `frontapp_mcp_server/`,
  `tests/`, `scripts/`
