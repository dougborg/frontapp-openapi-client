...
- SKIP (generated): `frontapp_public_api_client/api/**/*.py`,
  `frontapp_public_api_client/models/**/*.py`, `frontapp_public_api_client/client.py`
- SCAN: `frontapp_public_api_client/` (excluding generated paths above),
  `frontapp_mcp_server/`, `tests/`, `scripts/`
