# Frontapp TypeScript Client Documentation

This directory contains all documentation specific to the `frontapp-openapi-client`
TypeScript package.
...
- **[frontapp-openapi-client (Python)](../../../frontapp_public_api_client/docs/README.md)**
  \- Python client with the same features
- **[frontapp-mcp-server](../../../frontapp_mcp_server/docs/README.md)** - MCP server
