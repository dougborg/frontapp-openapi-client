...
`frontapp-client` TypeScript package — how the TS client layers resilience and
pagination on top of the hey-api-generated SDK.
...
- [Python Client ADRs](../../../frontapp_public_api_client/docs/adr/README.md) - Python
  client decisions
