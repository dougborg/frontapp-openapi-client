...
We need to generate TypeScript types and SDK functions from the Frontapp OpenAPI
...
export default {
  ...
  input: "../../docs/frontapp-openapi.yaml",
...
import { listConversations } from "./generated/sdk.gen.js";
const { data, error } = await listConversations({
  client,
  query: { q: "status:open", limit: 25 },
});
```
...
- [Python ADR-002: OpenAPI Code Generation](../../../frontapp_public_api_client/docs/adr/0002-openapi-code-generation.md)
