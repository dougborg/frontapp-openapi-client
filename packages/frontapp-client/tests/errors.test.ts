...
describe('Error Classes', () => {
  describe('FrontappError', () => {
    it('should create with message only', () => {
      const error = new FrontappError('Something went wrong');
    ...
    it('should create with all options', () => {
      ...
      const error = new FrontappError('Bad request', {
        statusCode: 400,
        response,
        body,
      });
    ...
    it('should store cause', () => {
      ...
      const error = new FrontappError('Wrapped error', { cause });
...
describe('parseError', () => {
  ...
  it('should return generic FrontappError for other 4xx', () => {
