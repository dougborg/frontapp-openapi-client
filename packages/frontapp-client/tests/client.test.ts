...
describe('FrontappClient', () => {
  ...
  describe('withApiKey', () => {
    it('should create client with explicit API key', () => {
      const client = FrontappClient.withApiKey(TEST_API_KEY);
    ...
    it('should use custom base URL', () => {
      ...
      const client = FrontappClient.withApiKey(TEST_API_KEY, { baseUrl: customUrl });
  ...
  describe('fetch method', () => {
    ...
    it('should add Content-Type header for POST requests with body', async () => {
      ...
      const client = FrontappClient.withApiKey(TEST_API_KEY, { fetch: mockFetch });
      await client.fetch('/orders', {
        method: 'POST',
