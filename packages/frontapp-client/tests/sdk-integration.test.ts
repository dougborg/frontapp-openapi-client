/**
 * Tests for SDK integration with FrontappClient
 *
...
describe('SDK Integration', () => {
  ...
  describe('SDK with FrontappClient', () => {
    it('should pass authentication through SDK calls', async () => {
      ...
      const frontapp = FrontappClient.withApiKey(TEST_API_KEY, {
        fetch: mockFetch,
        autoPagination: false,
      });

      await listOrders({ client: frontapp.sdk });
    ...
    it('should apply retry logic through SDK calls', async () => {
      ...
      const resultPromise = listOrders({ client: frontapp.sdk });
    ...
    it('should work with getConfig() helper', async () => {
      ...
      // Using getConfig() instead of { client: frontapp.sdk }
      await listOrders(frontapp.getConfig());
  ...
  describe('SDK error handling', () => {
    it('should return error response from SDK', async () => {
      ...
      const result = await listOrders({ client: frontapp.sdk });
