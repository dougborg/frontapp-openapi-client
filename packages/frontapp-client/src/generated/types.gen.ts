...
export type AnalyticsActivitiesExportsColumns = {
  /**
   * List of the columns to include in the export. In addition to the
   ...
   */
  columns: Array<
    AnalyticsActivitiesColumns | AnalyticsActivitiesParameterizedColumns
  >;
};

export type AnalyticsActivitiesParameterizedColumns =
  | string
  | string
  | string
  | string
...
export type AnalyticsActivitiesSmartQaScoreParameters =
  | "Comprehension"
  | "Solution_Offered"
  | "Professionalism"
...
export type AnalyticsMessagesColumns =
  | "Message ID"
  | "Segment ID"
  | "Conversation ID"
  | "Ticket IDs"
...
export type AnalyticsScalarType =
  | "number"
  | "percentage"
  | "string"
  | "duration"
...
export type CreateView = {
   ...
   */
  assignee_ids?: Array<ResourceId>;
  /**
   * List of assignee IDs to exclude
   */
  not_assignee_ids?: Array<ResourceId>;
  /**
...
export type SharedViewResponse = {
  _links: {
    ...
    related?: {
      /**
       * Link to the team that owns the view
       */
      owner?: string | null;
    };
  };
...
export type ListAccountCustomFieldsResponse =
  ListAccountCustomFieldsResponses[keyof ListAccountCustomFieldsResponses];
...
export type DeleteAnAccountResponse =
  DeleteAnAccountResponses[keyof DeleteAnAccountResponses];
...
export type FetchAnAccountResponse =
  FetchAnAccountResponses[keyof FetchAnAccountResponses];
...
export type RemoveContactFromAccountResponse =
  RemoveContactFromAccountResponses[keyof RemoveContactFromAccountResponses];
...
export type ListAccountContactsResponse =
  ListAccountContactsResponses[keyof ListAccountContactsResponses];
...
export type AddContactToAccountResponse =
  AddContactToAccountResponses[keyof AddContactToAccountResponses];
...
export type CreateAnalyticsExportResponse =
  CreateAnalyticsExportResponses[keyof CreateAnalyticsExportResponses];
...
export type GetAnalyticsExportResponse =
  GetAnalyticsExportResponses[keyof GetAnalyticsExportResponses];
...
export type CreateAnalyticsReportResponse =
  CreateAnalyticsReportResponses[keyof CreateAnalyticsReportResponses];
...
export type GetAnalyticsReportResponse =
  GetAnalyticsReportResponses[keyof GetAnalyticsReportResponses];
...
export type TriggerAppEventResponse =
  TriggerAppEventResponses[keyof TriggerAppEventResponses];
...
export type ReceiveCustomMessagesResponse =
  ReceiveCustomMessagesResponses[keyof ReceiveCustomMessagesResponses];
...
export type ValidateChannelResponse =
  ValidateChannelResponses[keyof ValidateChannelResponses];
...
export type ListCommentMentionsResponse =
  ListCommentMentionsResponses[keyof ListCommentMentionsResponses];
...
export type AddCommentReplyResponse =
  AddCommentReplyResponses[keyof AddCommentReplyResponses];
...
export type ListAllCompanyRulesResponse =
  ListAllCompanyRulesResponses[keyof ListAllCompanyRulesResponses];
...
export type ListCompanyTicketStatusesResponse =
  ListCompanyTicketStatusesResponses[keyof ListCompanyTicketStatusesResponses];
...
export type GetTicketStatusByIdResponse =
  GetTicketStatusByIdResponses[keyof GetTicketStatusByIdResponses];
...
export type ListCompanyTagsResponse =
  ListCompanyTagsResponses[keyof ListCompanyTagsResponses];
...
export type CreateCompanyTagResponse =
  CreateCompanyTagResponses[keyof CreateCompanyTagResponses];
...
export type RemoveContactsFromGroupResponse =
  RemoveContactsFromGroupResponses[keyof RemoveContactsFromGroupResponses];
...
export type ListContactsInGroupResponse =
  ListContactsInGroupResponses[keyof ListContactsInGroupResponses];
...
export type AddContactsToGroupResponse =
  AddContactsToGroupResponses[keyof AddContactsToGroupResponses];
...
export type ListContactListsResponse =
  ListContactListsResponses[keyof ListContactListsResponses];
...
export type CreateContactListResponse =
  CreateContactListResponses[keyof CreateContactListResponses];
...
export type DeleteContactListResponse =
  DeleteContactListResponses[keyof DeleteContactListResponses];
...
export type RemoveContactsFromContactListResponse =
  RemoveContactsFromContactListResponses[keyof RemoveContactsFromContactListResponses];
...
export type ListContactsInContactListResponse =
  ListContactsInContactListResponses[keyof ListContactsInContactListResponses];
...
export type AddContactsToContactListResponse =
  AddContactsToContactListResponses[keyof AddContactsToContactListResponses];
...
export type ListContactCustomFieldsResponse =
  ListContactCustomFieldsResponses[keyof ListContactCustomFieldsResponses];
...
export type MergeContactsResponse =
  MergeContactsResponses[keyof MergeContactsResponses];
...
export type DeleteAContactResponse =
  DeleteAContactResponses[keyof DeleteAContactResponses];
...
export type UpdateAContactResponse =
  UpdateAContactResponses[keyof UpdateAContactResponses];
...
export type ListContactConversationsResponse =
  ListContactConversationsResponses[keyof ListContactConversationsResponses];
...
export type DeleteContactHandleResponse =
  DeleteContactHandleResponses[keyof DeleteContactHandleResponses];
...
export type AddContactHandleResponse =
  AddContactHandleResponses[keyof AddContactHandleResponses];
...
export type ListConversationCustomFieldsResponse =
  ListConversationCustomFieldsResponses[keyof ListConversationCustomFieldsResponses];
...
export type SearchConversationsResponse =
  SearchConversationsResponses[keyof SearchConversationsResponses];
...
export type GetConversationByIdResponse =
  GetConversationByIdResponses[keyof GetConversationByIdResponses];
...
export type UpdateConversationAssigneeResponse =
  UpdateConversationAssigneeResponses[keyof UpdateConversationAssigneeResponses];
...
export type ListConversationCommentsResponse =
  ListConversationCommentsResponses[keyof ListConversationCommentsResponses];
...
export type ListConversationDraftsResponse =
  ListConversationDraftsResponses[keyof ListConversationDraftsResponses];
...
export type CreateDraftReplyResponse =
  CreateDraftReplyResponses[keyof CreateDraftReplyResponses];
...
export type ListConversationEventsResponse =
  ListConversationEventsResponses[keyof ListConversationEventsResponses];
...
export type DeleteConversationFollowersResponse =
  DeleteConversationFollowersResponses[keyof DeleteConversationFollowersResponses];
...
export type ListConversationFollowersResponse =
  ListConversationFollowersResponses[keyof ListConversationFollowersResponses];
...
export type AddConversationFollowersResponse =
  AddConversationFollowersResponses[keyof AddConversationFollowersResponses];
...
export type ListConversationInboxesResponse =
  ListConversationInboxesResponses[keyof ListConversationInboxesResponses];
...
export type RemoveConversationLinksResponse =
  RemoveConversationLinksResponses[keyof RemoveConversationLinksResponses];
...
export type AddConversationLinkResponse =
  AddConversationLinkResponses[keyof AddConversationLinkResponses];
...
export type CreateMessageReplyResponse =
  CreateMessageReplyResponses[keyof CreateMessageReplyResponses];
...
export type UpdateConversationRemindersResponse =
  UpdateConversationRemindersResponses[keyof UpdateConversationRemindersResponses];
...
export type RemoveConversationTagResponse =
  RemoveConversationTagResponses[keyof RemoveConversationTagResponses];
...
export type AddConversationTagResponse =
  AddConversationTagResponses[keyof AddConversationTagResponses];
...
export type ListCustomFieldsResponse =
  ListCustomFieldsResponses[keyof ListCustomFieldsResponses];
...
export type ListInboxesResponse =
  ListInboxesResponses[keyof ListInboxesResponses];
...
export type CreateInboxResponse =
  CreateInboxResponses[keyof CreateInboxResponses];
...
export type ListInboxCustomFieldsResponse =
  ListInboxCustomFieldsResponses[keyof ListInboxCustomFieldsResponses];
...
export type ListInboxChannelsResponse =
  ListInboxChannelsResponses[keyof ListInboxChannelsResponses];
...
export type CreateAChannelResponse =
  CreateAChannelResponses[keyof CreateAChannelResponses];
...
export type ListInboxConversationsResponse =
  ListInboxConversationsResponses[keyof ListInboxConversationsResponses];
...
export type ImportInboxMessageResponse =
  ImportInboxMessageResponses[keyof ImportInboxMessageResponses];
...
export type RemovesInboxAccessResponse =
  RemovesInboxAccessResponses[keyof RemovesInboxAccessResponses];
...
export type ListInboxAccessResponse =
  ListInboxAccessResponses[keyof ListInboxAccessResponses];
...
export type AddInboxAccessResponse =
  AddInboxAccessResponses[keyof AddInboxAccessResponses];
...
export type DeleteAnArticleResponse =
  DeleteAnArticleResponses[keyof DeleteAnArticleResponses];
...
export type GetAKnowledgeBaseArticleResponse =
  GetAKnowledgeBaseArticleResponses[keyof GetAKnowledgeBaseArticleResponses];
...
export type GetKnowledgeBaseArticleWithContentInDefaultLocaleResponse =
  GetKnowledgeBaseArticleWithContentInDefaultLocaleResponses[keyof GetKnowledgeBaseArticleWithContentInDefaultLocaleResponses];
...
export type UpdateArticleContentInDefaultLocaleResponse =
  UpdateArticleContentInDefaultLocaleResponses[keyof UpdateArticleContentInDefaultLocaleResponses];
...
export type GetKnowledgeBaseArticleWithContentInSpecifiedLocaleResponse =
  GetKnowledgeBaseArticleWithContentInSpecifiedLocaleResponses[keyof GetKnowledgeBaseArticleWithContentInSpecifiedLocaleResponses];
...
export type UpdateArticleContentInSpecifiedLocaleResponse =
  UpdateArticleContentInSpecifiedLocaleResponses[keyof UpdateArticleContentInSpecifiedLocaleResponses];
...
export type DeleteAKnowledgeBaseCategoryResponse =
  DeleteAKnowledgeBaseCategoryResponses[keyof DeleteAKnowledgeBaseCategoryResponses];
...
export type GetAKnowledgeBaseCategoryResponse =
  GetAKnowledgeBaseCategoryResponses[keyof GetAKnowledgeBaseCategoryResponses];
...
export type ListArticlesInACategoryResponse =
  ListArticlesInACategoryResponses[keyof ListArticlesInACategoryResponses];
...
export type GetKnowledgeBaseCategoryContentInDefaultLocaleResponse =
  GetKnowledgeBaseCategoryContentInDefaultLocaleResponses[keyof GetKnowledgeBaseCategoryContentInDefaultLocaleResponses];
...
export type UpdateKnowledgeBaseCategoryInDefaultLocaleResponse =
  UpdateKnowledgeBaseCategoryInDefaultLocaleResponses[keyof UpdateKnowledgeBaseCategoryInDefaultLocaleResponses];
...
export type GetKnowledgeBaseCategoryWithContentInSpecifiedLocaleResponse =
  GetKnowledgeBaseCategoryWithContentInSpecifiedLocaleResponses[keyof GetKnowledgeBaseCategoryWithContentInSpecifiedLocaleResponses];
...
export type UpdateKnowledgeBaseCategoryInSpecifiedLocaleResponse =
  UpdateKnowledgeBaseCategoryInSpecifiedLocaleResponses[keyof UpdateKnowledgeBaseCategoryInSpecifiedLocaleResponses];
...
export type CreateAKnowledgeBaseResponse =
  CreateAKnowledgeBaseResponses[keyof CreateAKnowledgeBaseResponses];
...
export type GetAKnowledgeBaseResponse =
  GetAKnowledgeBaseResponses[keyof GetAKnowledgeBaseResponses];
...
export type ListArticlesInAKnowledgeBaseResponse =
  ListArticlesInAKnowledgeBaseResponses[keyof ListArticlesInAKnowledgeBaseResponses];
...
export type CreateArticleInAKnowledgeBaseInDefaultLocaleResponse =
  CreateArticleInAKnowledgeBaseInDefaultLocaleResponses[keyof CreateArticleInAKnowledgeBaseInDefaultLocaleResponses];
...
export type ListCategoriesInAKnowledgeBaseResponse =
  ListCategoriesInAKnowledgeBaseResponses[keyof ListCategoriesInAKnowledgeBaseResponses];
...
export type CreateKnowledgeBaseCategoryInDefaultLocaleResponse =
  CreateKnowledgeBaseCategoryInDefaultLocaleResponses[keyof CreateKnowledgeBaseCategoryInDefaultLocaleResponses];
...
export type GetAKnowledgeBaseWithContentInDefaultLocaleResponse =
  GetAKnowledgeBaseWithContentInDefaultLocaleResponses[keyof GetAKnowledgeBaseWithContentInDefaultLocaleResponses];
...
export type UpdateKnowledgeBaseInDefaultLocaleResponse =
  UpdateKnowledgeBaseInDefaultLocaleResponses[keyof UpdateKnowledgeBaseInDefaultLocaleResponses];
...
export type CreateArticleInAKnowledgeBaseInSpecifiedLocaleResponse =
  CreateArticleInAKnowledgeBaseInSpecifiedLocaleResponses[keyof CreateArticleInAKnowledgeBaseInSpecifiedLocaleResponses];
...
export type CreateKnowledgeBaseCategoryInSpecifiedLocaleResponse =
  CreateKnowledgeBaseCategoryInSpecifiedLocaleResponses[keyof CreateKnowledgeBaseCategoryInSpecifiedLocaleResponses];
...
export type GetAKnowledgeBaseWithContentInSpecifiedLocaleResponse =
  GetAKnowledgeBaseWithContentInSpecifiedLocaleResponses[keyof GetAKnowledgeBaseWithContentInSpecifiedLocaleResponses];
...
export type UpdateKnowledgeBaseInSpecifiedLocaleResponse =
  UpdateKnowledgeBaseInSpecifiedLocaleResponses[keyof UpdateKnowledgeBaseInSpecifiedLocaleResponses];
...
export type ListLinkCustomFieldsResponse =
  ListLinkCustomFieldsResponses[keyof ListLinkCustomFieldsResponses];
...
export type UpdateALinkResponse =
  UpdateALinkResponses[keyof UpdateALinkResponses];
...
export type ListLinkConversationsResponse =
  ListLinkConversationsResponses[keyof ListLinkConversationsResponses];
...
export type ApiTokenDetailsResponse =
  ApiTokenDetailsResponses[keyof ApiTokenDetailsResponses];
...
export type GetChildFoldersResponse =
  GetChildFoldersResponses[keyof GetChildFoldersResponses];
...
export type CreateChildFolderResponse =
  CreateChildFolderResponses[keyof CreateChildFolderResponses];
...
export type GetChildTemplatesResponse =
  GetChildTemplatesResponses[keyof GetChildTemplatesResponses];
...
export type CreateChildTemplateResponse =
  CreateChildTemplateResponses[keyof CreateChildTemplateResponses];
...
export type ListMessageTemplatesResponse =
  ListMessageTemplatesResponses[keyof ListMessageTemplatesResponses];
...
export type CreateMessageTemplateResponse =
  CreateMessageTemplateResponses[keyof CreateMessageTemplateResponses];
...
export type DeleteMessageTemplateResponse =
  DeleteMessageTemplateResponses[keyof DeleteMessageTemplateResponses];
...
export type GetMessageTemplateResponse =
  GetMessageTemplateResponses[keyof GetMessageTemplateResponses];
...
export type UpdateMessageTemplateResponse =
  UpdateMessageTemplateResponses[keyof UpdateMessageTemplateResponses];
...
export type GetMessageSeenStatusResponse =
  GetMessageSeenStatusResponses[keyof GetMessageSeenStatusResponses];
...
export type MarkMessageSeenResponse =
  MarkMessageSeenResponses[keyof MarkMessageSeenResponses];
...
export type RemoveTeammatesFromShiftResponse =
  RemoveTeammatesFromShiftResponses[keyof RemoveTeammatesFromShiftResponses];
...
export type ListShiftsTeammatesResponse =
  ListShiftsTeammatesResponses[keyof ListShiftsTeammatesResponses];
...
export type AddTeammatesToShiftResponse =
  AddTeammatesToShiftResponses[keyof AddTeammatesToShiftResponses];
...
export type DeleteSignatureResponse =
  DeleteSignatureResponses[keyof DeleteSignatureResponses];
...
export type GetSignaturesResponse =
  GetSignaturesResponses[keyof GetSignaturesResponses];
...
export type UpdateSignatureResponse =
  UpdateSignatureResponses[keyof UpdateSignatureResponses];
...
export type ListTagChildrenResponse =
  ListTagChildrenResponses[keyof ListTagChildrenResponses];
...
export type CreateChildTagResponse =
  CreateChildTagResponses[keyof CreateChildTagResponses];
...
export type ListTaggedConversationsResponse =
  ListTaggedConversationsResponses[keyof ListTaggedConversationsResponses];
...
export type ListCompanyTeammateGroupsResponse =
  ListCompanyTeammateGroupsResponses[keyof ListCompanyTeammateGroupsResponses];
...
export type CreateCompanyTeammateGroupResponse =
  CreateCompanyTeammateGroupResponses[keyof CreateCompanyTeammateGroupResponses];
...
export type DeleteCompanyTeammateGroupResponse =
  DeleteCompanyTeammateGroupResponses[keyof DeleteCompanyTeammateGroupResponses];
...
export type GetCompanyTeammateGroupResponse =
  GetCompanyTeammateGroupResponses[keyof GetCompanyTeammateGroupResponses];
...
export type UpdateACompanyTeammateGroupResponse =
  UpdateACompanyTeammateGroupResponses[keyof UpdateACompanyTeammateGroupResponses];
...
export type RemoveCompanyTeammateGroupTeamInboxesResponse =
  RemoveCompanyTeammateGroupTeamInboxesResponses[keyof RemoveCompanyTeammateGroupTeamInboxesResponses];
...
export type ListCompanyTeammateGroupTeamInboxesResponse =
  ListCompanyTeammateGroupTeamInboxesResponses[keyof ListCompanyTeammateGroupTeamInboxesResponses];
...
export type AddCompanyTeammateGroupTeamInboxesResponse =
  AddCompanyTeammateGroupTeamInboxesResponses[keyof AddCompanyTeammateGroupTeamInboxesResponses];
...
export type RemoveCompanyTeammateGroupTeammatesResponse =
  RemoveCompanyTeammateGroupTeammatesResponses[keyof RemoveCompanyTeammateGroupTeammatesResponses];
...
export type ListCompanyTeammateGroupTeammatesResponse =
  ListCompanyTeammateGroupTeammatesResponses[keyof ListCompanyTeammateGroupTeammatesResponses];
...
export type AddCompanyTeammateGroupTeammatesResponse =
  AddCompanyTeammateGroupTeammatesResponses[keyof AddCompanyTeammateGroupTeammatesResponses];
...
export type RemoveCompanyTeammateGroupTeamsResponse =
  RemoveCompanyTeammateGroupTeamsResponses[keyof RemoveCompanyTeammateGroupTeamsResponses];
...
export type ListCompanyTeammateGroupTeamsResponse =
  ListCompanyTeammateGroupTeamsResponses[keyof ListCompanyTeammateGroupTeamsResponses];
...
export type AddCompanyTeammateGroupTeamsResponse =
  AddCompanyTeammateGroupTeamsResponses[keyof AddCompanyTeammateGroupTeamsResponses];
...
export type ListTeammatesResponse =
  ListTeammatesResponses[keyof ListTeammatesResponses];
...
export type ListTeammateCustomFieldsResponse =
  ListTeammateCustomFieldsResponses[keyof ListTeammateCustomFieldsResponses];
...
export type GetTeammateResponse =
  GetTeammateResponses[keyof GetTeammateResponses];
...
export type UpdateTeammateResponse =
  UpdateTeammateResponses[keyof UpdateTeammateResponses];
...
export type ListTeammateChannelsResponse =
  ListTeammateChannelsResponses[keyof ListTeammateChannelsResponses];
...
export type ListTeammateGroupsResponse =
  ListTeammateGroupsResponses[keyof ListTeammateGroupsResponses];
...
export type CreateTeammateGroupResponse =
  CreateTeammateGroupResponses[keyof CreateTeammateGroupResponses];
...
export type ListTeammateContactListsResponse =
  ListTeammateContactListsResponses[keyof ListTeammateContactListsResponses];
...
export type CreateTeammateContactListResponse =
  CreateTeammateContactListResponses[keyof CreateTeammateContactListResponses];
...
export type ListTeammateContactsResponse =
  ListTeammateContactsResponses[keyof ListTeammateContactsResponses];
...
export type CreateTeammateContactResponse =
  CreateTeammateContactResponses[keyof CreateTeammateContactResponses];
...
export type ListAssignedConversationsResponse =
  ListAssignedConversationsResponses[keyof ListAssignedConversationsResponses];
...
export type ListTeammateInboxesResponse =
  ListTeammateInboxesResponses[keyof ListTeammateInboxesResponses];
...
export type ListTeammateFoldersResponse =
  ListTeammateFoldersResponses[keyof ListTeammateFoldersResponses];
...
export type CreateTeammateFolderResponse =
  CreateTeammateFolderResponses[keyof CreateTeammateFolderResponses];
...
export type ListTeammateMessageTemplatesResponse =
  ListTeammateMessageTemplatesResponses[keyof ListTeammateMessageTemplatesResponses];
...
export type CreateTeammateMessageTemplateResponse =
  CreateTeammateMessageTemplateResponses[keyof CreateTeammateMessageTemplateResponses];

export type ListTeammatePrivateInboxesData = {
  body?: never;
  path: {
    /**
     * The teammate ID
...
export type ListTeammatePrivateInboxesResponses = {
  /**
   * Array of Inboxes
   */
  200: {
...
export type ListTeammatePrivateInboxesResponse =
  ListTeammatePrivateInboxesResponses[keyof ListTeammatePrivateInboxesResponses];

export type CreateTeammatePrivateInboxData = {
  /**
   * Inbox details
   */
  body?: CreatePrivateInbox;
  path: {
    /**
     * The teammate ID
     */
...
export type CreateTeammatePrivateInboxResponses = {
  /**
   * An inbox
   */
  201: InboxResponse;
...
export type CreateTeammatePrivateInboxResponse =
  CreateTeammatePrivateInboxResponses[keyof CreateTeammatePrivateInboxResponses];
...
export type ListTeammateRulesResponse =
  ListTeammateRulesResponses[keyof ListTeammateRulesResponses];
...
export type ListTeammateShiftsResponse =
  ListTeammateShiftsResponses[keyof ListTeammateShiftsResponses];
...
export type ListTeammateSignaturesResponse =
  ListTeammateSignaturesResponses[keyof ListTeammateSignaturesResponses];
...
export type CreateTeammateSignatureResponse =
  CreateTeammateSignatureResponses[keyof CreateTeammateSignatureResponses];
...
export type ListTeammateTagsResponse =
  ListTeammateTagsResponses[keyof ListTeammateTagsResponses];
...
export type CreateTeammateTagResponse =
  CreateTeammateTagResponses[keyof CreateTeammateTagResponses];
...
export type ListTeamChannelsResponse =
  ListTeamChannelsResponses[keyof ListTeamChannelsResponses];
...
export type ListTeamGroupsResponse =
  ListTeamGroupsResponses[keyof ListTeamGroupsResponses];
...
export type CreateTeamGroupResponse =
  CreateTeamGroupResponses[keyof CreateTeamGroupResponses];
...
export type ListTeamContactListsResponse =
  ListTeamContactListsResponses[keyof ListTeamContactListsResponses];
...
export type CreateTeamContactListResponse =
  CreateTeamContactListResponses[keyof CreateTeamContactListResponses];
...
export type ListTeamContactsResponse =
  ListTeamContactsResponses[keyof ListTeamContactsResponses];
...
export type CreateTeamContactResponse =
  CreateTeamContactResponses[keyof CreateTeamContactResponses];
...
export type ListTeamInboxesResponse =
  ListTeamInboxesResponses[keyof ListTeamInboxesResponses];

export type CreateTeamInboxData = {
  /**
   * Inbox details
   */
  body?: CreateTeamInbox;
  path: {
    /**
     * The team ID
     */
...
export type CreateTeamInboxResponse =
  CreateTeamInboxResponses[keyof CreateTeamInboxResponses];
...
export type ListTeamFoldersResponse =
  ListTeamFoldersResponses[keyof ListTeamFoldersResponses];
...
export type CreateTeamFolderResponse =
  CreateTeamFolderResponses[keyof CreateTeamFolderResponses];
...
export type ListTeamMessageTemplatesResponse =
  ListTeamMessageTemplatesResponses[keyof ListTeamMessageTemplatesResponses];
...
export type CreateTeamMessageTemplateResponse =
  CreateTeamMessageTemplateResponses[keyof CreateTeamMessageTemplateResponses];
...
export type ListTeamRulesResponse =
  ListTeamRulesResponses[keyof ListTeamRulesResponses];
...
export type ListTeamShiftsResponse =
  ListTeamShiftsResponses[keyof ListTeamShiftsResponses];
...
export type CreateTeamShiftResponse =
  CreateTeamShiftResponses[keyof CreateTeamShiftResponses];
...
export type ListTeamSignaturesResponse =
  ListTeamSignaturesResponses[keyof ListTeamSignaturesResponses];
...
export type CreateTeamSignatureResponse =
  CreateTeamSignatureResponses[keyof CreateTeamSignatureResponses];
...
export type ListTeamTagsResponse =
  ListTeamTagsResponses[keyof ListTeamTagsResponses];
...
export type CreateTeamTagResponse =
  CreateTeamTagResponses[keyof CreateTeamTagResponses];
...
export type RemoveTeammatesFromTeamResponse =
  RemoveTeammatesFromTeamResponses[keyof RemoveTeammatesFromTeamResponses];
...
export type AddTeammatesToTeamResponse =
  AddTeammatesToTeamResponses[keyof AddTeammatesToTeamResponses];

export type ListTeamViewsData = {
  body?: never;
  path: {
    /**
     * The team ID
...
export type ListTeamViewsResponses = {
  /**
   * Array of views
   */
  200: {
    ...
    _results?: Array<SharedViewResponse>;
  };
};

export type ListTeamViewsResponse =
  ListTeamViewsResponses[keyof ListTeamViewsResponses];
...
export type CreateTeamViewResponses = {
   ...
   * A view
   */
  201: SharedViewResponse;
};

export type CreateTeamViewResponse =
  CreateTeamViewResponses[keyof CreateTeamViewResponses];
...
export type AddViewTeammatesData = {
  /**
   * Teammate IDs to add. Alternatively, you can supply emails as a [resource alias](https://dev.frontapp.com/docs/resource-aliases-1).
   */
  body?: {
...
export type AddViewTeammatesResponses = {
  /**
   * No content
   */
  204: void;
...
export type AddViewTeammatesResponse =
  AddViewTeammatesResponses[keyof AddViewTeammatesResponses];
