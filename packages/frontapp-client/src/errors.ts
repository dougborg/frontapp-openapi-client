/**
 * Typed error hierarchy for Frontapp API errors
 *
 * Mirrors the Python client's error handling pattern from frontapp_client.py
 */

/**
 * Base error class for all Frontapp API errors
 */
 ...
 */
export class AuthenticationError extends FrontappError {
  constructor(
 ...
 */
export class RateLimitError extends FrontappError {
 ...
 */
export class ValidationError extends FrontappError {
 ...
 * Server error (5xx)
 */
export class ServerError extends FrontappError {
  constructor(
 ...
 */
export class NetworkError extends FrontappError {
 ...
 */
export function parseError(response: Response, body?: unknown): FrontappError {
  ...
  return new FrontappError(message, {
    statusCode: status,
    response,
    body,
  });
...
function parseValidationDetails(body: unknown): ValidationErrorDetail[] {
  ...
  // Handle Frontapp's error format
